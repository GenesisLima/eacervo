...
<!--   </div> -->
 <!-- <a id="reload" href="">Click me to refresh the table!</a> -->
    <datatables:table id="scheduleTable" row="schedule" data="${schedules}"   theme="bootstrap3" cssClass="table table-striped"  paginationType="full_numbers" displayLength="5">
...
<%--        	<datatables:column title="DESCRIÇÃO" property="description" />  --%>
   ...
   <a href="#" id="editButton" class="btn btn-info" role="button" data-toggle="modal" data-id="${schedule.id}" data-area="${schedule.name}" data-description="${schedule.description}" data-target="#myModal" onclick="setValues()">Editar</a>
   <a href="/eacervo/insertions/remove/${schedule.id}" class="btn btn-info" role="button">Remover</a>
...
<div id="myModal" class="modal fade" role="dialog">
 ...
 <form role="form" class="schedule">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Inserção</h4>
      </div>
...
<!--         <p>Fun&ccedil;&atilde;o</p> -->
        ...
        <div class="form-group">
           ...
           <div class="form-group">                     
              <label for="episodeName">Inserção</label>
              <input type="text" class="form-control"  name="episodeName" id="episodeName"></input>             
           </div>
      ...
      <div class="modal-footer">
       ...
       function setValues(){
        $('#myModal').on('show.bs.modal', function (e) {
        	  ...
        	  modal.find('#episodeName').val(name)
