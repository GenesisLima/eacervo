...
<!--   </div> -->
 <!-- <a id="reload" href="">Click me to refresh the table!</a> -->
    <datatables:table id="servidoresTable" row="servidor" data="${employees}"   theme="bootstrap3" cssClass="table table-striped"  paginationType="full_numbers" displayLength="5">
        
        <datatables:column title="ID" property="id"   />
        <datatables:column title="NAME" property="name"/>
        <datatables:column title="RAMAL" property="branchLine"/>
<%--        	<datatables:column title="DESCRIPTION" property="description" /> --%>
      <datatables:column title="AÇÃO" >
       
   <a href="#" id="editButton" class="btn btn-info" role="button" data-toggle="modal" data-id="${servidor.id}" data-name="${servidor.name}" data-branchLine="${servidor.branchLine}" data-target="#myModal" onclick="setValues()">Editar</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
              ...
              <input type="text" class="form-control" id="employee" name="id" >
           ...
           <div class="form-group">
              ...
              <textarea type="text"  class="form-control" name="branchLine" id="branchLine"></textarea>
           </div>
  </form><!-- /end form-->
      </div>
      <div class="modal-footer">
       ...
       function setValues(){
        $('#myModal').on('show.bs.modal', function (e) {
        	  ...
        	  var desc = button.data('branchLine')
        	  // Extract info from data-* attributes
        	  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
        	  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
        	  var modal = $(this);
        	      	 
        	  modal.find('#employee').val(recipient)
        	  modal.find('#name').val(name)
        	  modal.find('#branchLine').val(desc)
