...
<div class="panel panel-default">
  <div class="panel-heading">Cadastrar Origem</div>
  <div class="panel-body">
        <form role="form" method="post" action="/eacervo/origens">
           <div class="form-group">
    <label for="area_id">ID:</label>
    <input type="text" class="form-control" id="origin_id" name="origin_id" readonly="readonly" value="0">
  </div>
           <div class="form-group">
