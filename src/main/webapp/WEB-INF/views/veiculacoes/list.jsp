...
<!--   </div> -->
 <!-- <a id="reload" href="">Click me to refresh the table!</a> -->
    <datatables:table id="publishingsTable" row="publishing" data="${publishings}"   theme="bootstrap3" cssClass="table table-striped"  paginationType="full_numbers" displayLength="5">
        
        <datatables:column title="ID" property="id"   />
        <datatables:column title="VEICULA&Ccedli;&Atilde;O" property="name"/>
<%--        	<datatables:column title="DESCRIÇÃO" property="description" />  --%>
      <datatables:column title="AÇÃO" >
       
   <a href="#" id="editButton" class="btn btn-info" role="button" data-toggle="modal" data-id="${publishing.id}" data-name="${publishing.name}" data-description="${publishing.description}" data-target="#myModal" onclick="setValues()">Editar</a>
   <a href="/eacervo/veiculacoes/remove/${publishing.id}" class="btn btn-info" role="button">Remover</a>
...
<div id="myModal" class="modal fade" role="dialog">
 ...
 <form role="form" class="veiculacao">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Veicula&ccedil;&aatilde;o</h4>
      </div>
...
<!--         <p>Fun&ccedil;&atilde;o</p> -->
        ...
        <div class="form-group">
           ...
           <div class="form-group">                     
              <label for="name">Veicula&ccedil;&aatilde;o:</label>
...
//twitter bootstrap script
 $("button#submit").click(function(){
         $.ajax({
     type: "POST",
 url: "/eacervo/veiculacoes",
 data: $('form.veiculacao').serialize(),
